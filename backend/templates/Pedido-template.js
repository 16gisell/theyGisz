...
this.enviaremail =(nombreCliente, tlfCliente, typeEntrega, descripcion, fechaEntrega) =>{
    ...
    let mail_opcions ={
        ...
        `
            <table border="1" cellpadding="0" cellspacing="0" width="100%">
                <tr bgcolor="#565353">
                    <td>
                        <h1 style="font-size: 45px; font-family: fantasy; color:white; text-shadow:2px 3px 4px #ca2372;" align="center">Han solicitado un pedido por parte de:  ${nombreCliente}</h1>
                    </td>                    
                </tr>
                <tr>

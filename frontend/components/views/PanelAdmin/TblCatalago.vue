<template>
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2 textTitles"><img src="/image/iconoP.png"> Contenido Catálago</h1>
        </div>
            ...
            <table class="table table-striped table-dark">
                ...
                <tbody>
                    <tr v-for="item, index of pedidos">
                        ...
                        <td><img :src="'/'+item.imgCatalago" style="width: 100px;"></td>
                        <td>{{item.descripcion}}</td>
                        <td>{{item.typeCatalago}}</td>
                        <td>
    ...
    export default {
        ...
        methods: {
            ...
            async deleteCatalago(id){
                await adminWebServices.deliteCatalago(id);
